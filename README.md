...
**Breakpoint:** Test each of your endpoints with POSTMan and either the command line or RoboMongo to ensure that everything is happening as expected.  If you need some dummy data, it is provided in the `birds.js` file.
